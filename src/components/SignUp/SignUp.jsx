...
function SignUp() {
  ...
  return (
    <div
      className={`sign-form ${active ? "active" : ""}`}
          ...
          <Form className="sign-form_conteiner_formik_block">
            <div className="sign-form_conteiner_formik_block_inputs">
              <div className="sign-form_conteiner_formik_block_inputs_login">
                <label
                  htmlFor="login"
                  className="sign-form_conteiner_formik_block_inputs_login_label"
                >
                  Login:
                </label>
                <Field
                  ...
                  name="login"
                  autoComplete="off"
                  className="sign-form_conteiner_formik_block_inputs_login_input"
                />
              </div>
              <div className="sign-form_conteiner_formik_block_inputs_pass">
                <label
                  htmlFor="password"
                  className="sign-form_conteiner_formik_block_inputs_pass_label"
                >
                  Password:
                </label>
                <Field
                  ...
                  name="password"
                  autoComplete="off"
                  className="sign-form_conteiner_formik_block_inputs_pass_input"
                />
              </div>
              <div className="sign-form_conteiner_formik_block_inputs_pass-conf">
                <label
                  htmlFor="password-conf"
                  className="sign-form_conteiner_formik_block_inputs_pass-conf_label"
                >
                ...
                <Field
                  ...
                  id="password-conf"
                  name="password-conf"
                  className="sign-form_conteiner_formik_block_inputs_pass-conf_input"
                />
              </div>
              <div className="sign-form_conteiner_formik_block_inputs_mail">
                <label
                  htmlFor="email"
                  className="sign-form_conteiner_formik_block_inputs_mail_label"
                >
                  Email:
                </label>
                <Field
                  ...
                  id="email"
                  name="email"
                  className="sign-form_conteiner_formik_block_inputs_mail_input"
                />
              </div>
            </div>
